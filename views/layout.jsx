...
const DESCRIPTION = 'At your own risk';
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="stylesheet" href="/css/watson-react-components.css" />
        <link rel="stylesheet" href="/css/style.css" />
      </head>
      <body>
        <Jumbotron
          serviceName="Speech To Text Demo - Watson Cafe 参加者特典"
          originaldemo="https://speech-to-text-demo.ng.bluemix.net/"
